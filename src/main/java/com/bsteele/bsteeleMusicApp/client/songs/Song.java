...
//        }
    ...
    public static final boolean containsSongTitleAndArtist(Collection<Song> collection, Song song)
    {
        for (Song collectionSong : collection) {
            if (song.compareTo(collectionSong) == 0)
                return true;
        }
        return false;
    }
